...
define(['core/modal_save_cancel', 'core/modal_events', 'core/str'], function(ModalSaveCancel, ModalEvents, Str) {
     ...
     * button label — same fix applied to mod_playerwords's own equivalent modals.
     *
    ...
    const initAiGenerate = () => {
        const form = document.getElementById('playercross-ai-generate-form');
        const btn = document.getElementById('playercross-ai-generate-btn');
        if (!form || !btn) {
            return;
        }
