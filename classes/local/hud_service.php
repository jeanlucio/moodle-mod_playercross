...
class hud_service {
    ...
    /**
     * Bulk-resolves the XP value of several items at once, keyed by item id — used
     * where a caller needs the XP of many items in one pass instead of one
     * \block_playerhud\local\external_items::get_xp() query per item.
     *
