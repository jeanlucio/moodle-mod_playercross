...
1. Adicione uma atividade **PlayerCross** ao seu curso.
2. Configure:
...
4. O estudante joga diretamente na página da atividade — resolvendo pistas, chutando a frase-mistério, revelando dicas e desistindo de rodadas, sem recarregar a página. A própria barra de ferramentas da página dá acesso às regras (ajuda), ao histórico de tentativas e ao ranking.
