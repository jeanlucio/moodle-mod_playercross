...
* **Bloco PlayerHUD (Opcional, v1.7.1+):** Configure custos em itens para iniciar uma rodada ou revelar a dica de um termo, e uma concessão de item por rodada vencida.
