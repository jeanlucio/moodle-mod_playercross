...
$string['clueexhaustedlabel'] = 'Sem sucesso após {$a} tentativas.';
$string['clueguesswrong'] = 'Palpite incorreto. Tente novamente.';
...
$string['error_manualhintrequired'] = 'A dica é obrigatória — ela é exibida ao estudante como a própria pista.';
...
$string['feedback_cluesexhausted'] = 'Uma pista esgotou as tentativas — não é mais possível vencer esta rodada.';
...
$string['help_clueexhausted'] = 'Cada pista tem um número limitado de tentativas. Se elas se esgotarem, vencer se torna impossível e a rodada é encerrada imediatamente como derrota.';
$string['help_clues'] = 'Cada pista é uma palavra separada sobre um conceito do curso; digite o palpite na caixa ao lado dela — cada letra digitada avança automaticamente para a próxima caixa.';
...
$string['help_submit'] = 'Assim que terminar de digitar uma palavra, um botão aparece ao lado dela para conferir essa palavra — não é preciso preencher todas as pistas antes.';
...
$string['help_wincondition_finalonly'] = 'Para vencer uma rodada, acerte a frase-mistério a qualquer momento; resolver as pistas é opcional, mas ainda ajuda revelando letras.';
...
$string['manualhintplaceholder'] = 'Dica curta que ajuda o estudante a adivinhar a palavra';
...
$string['privacy:metadata:playercross_words:hint'] = 'Texto de dica opcional para a palavra.';
...
$string['theme_max_length_help'] = 'O total máximo de letras (somando todas as palavras, sem contar espaços) permitido na dica de uma palavra para que ela seja elegível como frase-mistério. Use 0 para não ter limite. Um teto menor mantém a frase-mistério mais rápida de digitar, letra por letra, numa tela pequena.';
...
$string['themeeligiblewordscount'] = 'Dicas elegíveis para a frase-mistério neste intervalo: {$a}.';
...
$string['win_condition_both'] = 'Ambos obrigatórios: todas as pistas resolvidas e a frase-mistério acertada';
$string['win_condition_finalonly'] = 'Só a frase-mistério: resolver pistas ajuda, mas só a frase encerra a rodada';
$string['win_condition_help'] = 'Escolha qual ação encerra a rodada: <ul><li><strong>Ambos obrigatórios:</strong> a rodada só termina quando todas as pistas forem resolvidas e a frase-mistério também tiver sido acertada. Se uma pista esgotar as tentativas nesse modo, a vitória fica impossível e a rodada é encerrada automaticamente como derrota.</li><li><strong>Só a frase-mistério:</strong> resolver pistas ainda ajuda, revelando letras, mas só um palpite correto da frase-mistério encerra a rodada — mesmo depois de resolver todas as pistas, o estudante ainda precisa digitar a frase.</li></ul>';
