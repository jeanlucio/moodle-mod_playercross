...
$string['error_manualhintrequired'] = 'Hint is required — it is shown to students as the clue itself.';
...
$string['help_clueexhausted'] = 'Each clue has a limited number of attempts. If one runs out, winning becomes impossible and the round ends immediately as a loss.';
$string['help_clues'] = 'Each clue is a separate word about a course concept; guess it in the box next to it — each letter you type moves you to the next box automatically.';
...
$string['help_submit'] = 'As soon as you finish typing a word, a button appears right next to it to check that word — you do not need to fill in every clue first.';
...
$string['help_wincondition_finalonly'] = 'To win a round, guess the mystery phrase correctly at any time; resolving clues is optional but still helps by revealing letters.';
...
$string['manualhintplaceholder'] = 'Short clue that helps students guess the word';
...
$string['privacy:metadata:playercross_words:hint'] = 'Optional hint text for the word.';
