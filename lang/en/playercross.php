...
$string['max_attempts_per_term_help'] = 'The maximum number of guesses a student may submit for a single term before it is considered unsolved for the rest of the round. Set to 0 to allow unlimited attempts per term.';
...
$string['scoringmode_locked'] = 'Because this activity has already recorded a real grade for at least one student, the number of terms and the grading method can no longer be changed — changing them afterwards would make past and future rounds count on different scales.';
