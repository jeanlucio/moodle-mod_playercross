...
📚 **[Full documentation](https://jeanlucio.github.io/moodle-mod_playercross/)** — features, educational purpose, the PlayerGames ecosystem, usage guide, grading & ranking model, the full 341-case PHPUnit suite plus a 28-scenario Behat suite, and security details.
...
📚 **[Documentação completa](https://jeanlucio.github.io/moodle-mod_playercross/pt.html)** — funcionalidades, finalidade educacional, ecossistema PlayerGames, guia de uso, modelo de nota e ranking, a suíte completa de 341 testes PHPUnit mais uma suíte Behat de 28 cenários, e detalhes de segurança.
