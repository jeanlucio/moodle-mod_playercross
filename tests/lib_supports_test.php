...
/**
 * Tests for the playercross_supports callback in lib.php.
 *
...
/**
 * Tests for playercross_supports() — no database access needed.
 *
 * @covers ::playercross_supports
 */
final class lib_supports_test extends \basic_testcase {
    ...
    public function test_supports_known_features(): void {
        $this->assertTrue(playercross_supports(FEATURE_MOD_INTRO));
        $this->assertTrue(playercross_supports(FEATURE_BACKUP_MOODLE2));
        $this->assertTrue(playercross_supports(FEATURE_COMPLETION_HAS_RULES));
        $this->assertTrue(playercross_supports(FEATURE_GRADE_HAS_GRADE));
        $this->assertSame(MOD_PURPOSE_INTERACTIVECONTENT, playercross_supports(FEATURE_MOD_PURPOSE));
        $this->assertNull(playercross_supports('unknown_feature'));
    }
    ...
    public function test_supports_secondary_purpose_when_available(): void {
        ...
        $this->assertSame(MOD_PURPOSE_ASSESSMENT, playercross_supports(FEATURE_MOD_OTHERPURPOSE));
    }
}
