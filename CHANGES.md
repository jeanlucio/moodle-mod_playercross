...
- Round state (the mystery phrase, clues, revealed letters, timer) moved from the raw session
...
### Fixed
- Uninstalling the activity left every `mod_playercross_*` entry behind in the site's user
